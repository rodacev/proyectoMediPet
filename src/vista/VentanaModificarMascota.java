...
public class VentanaModificarMascota extends javax.swing.JFrame {
     ...
     */
    public VentanaModificarMascota() {
        initComponents(); 
    }
    
    public VentanaModificarMascota(int id) {
        initComponents(); 
        sp_codigo.setValue(id);
        
        Mascota mascota = obtenerMascotaPorId(id);
        
        txt_nombre.setText(mascota.getNom_mascota());
        sp_edad.setValue(mascota.getEdad_mascota());
        cmb_tipo.setSelectedItem(mascota.getTipo_mascota());
        chk_atencionesPrevias.setSelected(mascota.isAte_hist_mascota());
        sp_cantidadAtenciones.setValue(mascota.getCant_ate_mascota());
        chk_prop.setSelected(mascota.isProp_mascota());
        txt_nombreProp.setText(mascota.getNom_prop());
        txt_descripcion.setText(mascota.getDesc_mascota());
    ...
    private Mascota obtenerMascotaPorId(int id) {
        ...
        try {
            ...
            mascota = ctrlMascota.mascotaObtenerPorId(id);
            return mascota;            
        }
    ...
    private void initComponents() {
        ...
        sp_codigo = new javax.swing.JSpinner();
        ...
        btn_modificar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/save.png"))); // NOI18N
        ...
        lbl_codigo.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 18)); // NOI18N
        lbl_codigo.setText("Código:");

        sp_codigo.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        sp_codigo.setEnabled(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(sp_codigo, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(94, 94, 94))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbl_codigo)
                    .addComponent(sp_codigo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lbl_nombre)
                    .addComponent(lbl_edad)
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        try {
            ...
            mascota.setId_mascota((int)sp_codigo.getValue());
            ...
            ctrlMascota.mascotaModificar(mascota);
            
            

            JOptionPane.showMessageDialog(rootPane, "MASCOTA MODIFICADA CORRECTAMENTE");
            }
    ...
    private javax.swing.JSpinner sp_codigo;
